...
const [dvr_age,setDvr_age] =useState("")

const vehicle_age = new Date().getFullYear()-parseInt(rptPsv.psvModal)
                ...
                await axios
                  ...
                  .then(async response => {
                    ...
                    if (driverDetail) {
                     ...
                     setDvr_age(new Date().getFullYear()- new Date(driverDetail.dob).getFullYear())
    ...
    <ScrollView >
      ...
      {/* <ActivityIndicator size="small" color="red" animating={show}/>  */}
          ...
          <View className=" mt-1 w-full  ">
            ...
            {/* Show Vehicle Number */}
            <View className=" bg-[#5ec44a]  rounded-md m-1 w-fit items-center justify-center flex-col ">
              <Text className="text-black text-lg rounded-md font-bold ">
                Report of BUS No: {v_psvNo}
              </Text>
            <Text className={`w-full text-[15px] rounded-b-md ${vehicle_age>19? "text-red-600":"text-black"}  text-center bg-zinc-200 font-bold`}>Vehicle manufactured    
              <Text className='font-extrabold text-xl   rounded-lg p-1'> {vehicle_age} </Text>years ago.</Text>
          ...
          <TouchableOpacity className="w-full px-1 rounded-md" onPress={()=>navigation.navigate("Other Info",{params:"report"})}>
            ...
            <View className=" bg-[#5ec44a]  rounded-md m-1 w-fit items-center justify-center flex-col">
              ...
              <Text className={` w-full text-[15px] flex items-center justify-center ${dvr_age>59 ||dvr_age<21?"text-red-600":"text-black"} text-center rounded-b-md  bg-zinc-300 font-bold`}>Driver is    
              <Text className='font-extrabold text-xl   rounded-b-lg p-1'>{dvr_age} </Text>years old.</Text>
